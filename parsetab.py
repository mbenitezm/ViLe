...
_lr_productions = [
  ...
  ('expression -> expression2 expressionoptional','expression',2,'p_expression','parser.py',112),
  ('expressionoptional -> logicop expression2','expressionoptional',2,'p_expressionoptional','parser.py',115),
  ('expressionoptional -> <empty>','expressionoptional',0,'p_expressionoptional','parser.py',116),
  ('expression2 -> exp expression2optional','expression2',2,'p_expression2','parser.py',119),
  ('expression2optional -> relop exp','expression2optional',2,'p_expression2optional','parser.py',122),
  ('expression2optional -> <empty>','expression2optional',0,'p_expression2optional','parser.py',123),
  ('logicop -> AND','logicop',1,'p_logicop','parser.py',126),
  ('logicop -> OR','logicop',1,'p_logicop','parser.py',127),
  ('relop -> EQUALITY','relop',1,'p_relop','parser.py',130),
  ('relop -> GREATER','relop',1,'p_relop','parser.py',131),
  ('relop -> GREATER_EQUAL','relop',1,'p_relop','parser.py',132),
  ('relop -> LESS','relop',1,'p_relop','parser.py',133),
  ('relop -> LESS_EQUAL','relop',1,'p_relop','parser.py',134),
  ('relop -> DIFFERENT','relop',1,'p_relop','parser.py',135),
  ('exp -> term exploop','exp',2,'p_exp','parser.py',139),
  ('exploop -> addsub exp','exploop',2,'p_exploop','parser.py',143),
  ('exploop -> <empty>','exploop',0,'p_exploop','parser.py',144),
  ('addsub -> SUM','addsub',1,'p_addsub','parser.py',147),
  ('addsub -> MINUS','addsub',1,'p_addsub','parser.py',148),
  ('term -> fact termloop','term',2,'p_term','parser.py',151),
  ('termloop -> divmult term','termloop',2,'p_termloop','parser.py',155),
  ('termloop -> <empty>','termloop',0,'p_termloop','parser.py',156),
  ('divmult -> MULTIPLY','divmult',1,'p_divmult','parser.py',159),
  ('divmult -> DIVIDE','divmult',1,'p_divmult','parser.py',160),
  ('divmult -> MOD','divmult',1,'p_divmult','parser.py',161),
  ('fact -> varconst','fact',1,'p_fact','parser.py',164),
  ('fact -> O_PARENTHESIS expression C_PARENTHESIS','fact',3,'p_fact','parser.py',165),
  ('var -> ID listaccess','var',2,'p_var','parser.py',169),
  ('listaccess -> O_S_BRACKET INTCONST C_S_BRACKET','listaccess',3,'p_listaccess','parser.py',173),
  ('listaccess -> <empty>','listaccess',0,'p_listaccess','parser.py',174),
  ('varconst -> varconstfunction','varconst',1,'p_varconst','parser.py',177),
  ('varconst -> constants','varconst',1,'p_varconst','parser.py',178),
  ('varconstfunction -> ID functionorlist','varconstfunction',2,'p_varconstfunction','parser.py',181),
  ('functionorlist -> O_S_BRACKET INTCONST C_S_BRACKET','functionorlist',3,'p_functionoflist','parser.py',184),
  ('functionorlist -> O_PARENTHESIS parametersinput C_PARENTHESIS','functionorlist',3,'p_functionoflist','parser.py',185),
  ('functionorlist -> <empty>','functionorlist',0,'p_functionoflist','parser.py',186),
  ('constants -> INTCONST','constants',1,'p_constants','parser.py',190),
  ('constants -> FLOATCONST','constants',1,'p_constants','parser.py',191),
  ('constants -> STRINGCONST','constants',1,'p_constants','parser.py',192),
  ('constants -> booleanconst','constants',1,'p_constants','parser.py',193),
  ('booleanconst -> TRUE','booleanconst',1,'p_booleanconst','parser.py',197),
  ('booleanconst -> FALSE','booleanconst',1,'p_booleanconst','parser.py',198),
  ('loop -> whileloop','loop',1,'p_loop','parser.py',202),
  ('loop -> timesloop','loop',1,'p_loop','parser.py',203),
  ('whileloop -> WHILE O_PARENTHESIS expression C_PARENTHESIS block','whileloop',5,'p_whileloop','parser.py',207),
  ('timesloop -> TIMES O_PARENTHESIS INTCONST C_PARENTHESIS block','timesloop',5,'p_timesloop','parser.py',211),
  ('functioncall -> ID O_PARENTHESIS parametersinput C_PARENTHESIS SEMICOLON','functioncall',5,'p_functioncall','parser.py',215),
  ('parametersinput -> expression parametersinputloop','parametersinput',2,'p_parametersinput','parser.py',219),
  ('parametersinput -> <empty>','parametersinput',0,'p_parametersinput','parser.py',220),
  ('parametersinputloop -> COMMA expression parametersinputloop','parametersinputloop',3,'p_parametersinputloop','parser.py',223),
  ('parametersinputloop -> <empty>','parametersinputloop',0,'p_parametersinputloop','parser.py',224),
  ('parameters -> type ID parametersloop','parameters',3,'p_parameters','parser.py',227),
  ('parameters -> <empty>','parameters',0,'p_parameters','parser.py',228),
  ('parametersloop -> COMMA type ID parametersloop','parametersloop',4,'p_parametersloop','parser.py',232),
  ('parametersloop -> <empty>','parametersloop',0,'p_parametersloop','parser.py',233),
]
